...
public class myHttp extends AsyncTask<String, String, Integer>{
    ...
    protected Integer doInBackground(String... params) {
        ...
        String hostName = "students.engr.scu.edu/~smaram/Srinu/gcm.php?shareRegId=1";
        ...
        try {
            ...
            postParams.add(new BasicNameValuePair("regId", phoneNumber+"\n"));
